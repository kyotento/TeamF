...
public:
	...
	static constexpr float DRAWING_SKY_LIGHT[LIGHT_POWER_COUNT] = {
		0.035f * 0.8f,
		0.043f * 0.8f, 0.054f * 0.8f, 0.068f * 0.8f, 0.085f * 0.8f, 0.107f * 0.8f,
		0.134f * 0.8f, 0.167f * 0.8f, 0.209f * 0.8f, 0.262f * 0.8f, 0.327f * 0.8f,
		0.4096f * 0.8f, 0.512f * 0.8f, 0.64f * 0.8f, 0.8f*0.8f, 1.0f
	};
